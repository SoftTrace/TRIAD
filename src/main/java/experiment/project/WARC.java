...
public class WARC implements Project{
    ...
    private static String level1BitermPath = "/NFR";
    private static String level2BitermPath = "/SRS";
    private static String level3BitermPath = "/FRS";
    private static String bitermDirPath = "dataset/warc/biterm/";
