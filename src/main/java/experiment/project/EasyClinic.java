...
public class EasyClinic implements Project{
    private static String projectName = "easyclinic";

    private static String processedLevel1Path = "dataset/easyclinic/processed/use_case";
    private static String processedLevel2Path = "dataset/easyclinic/processed/interaction_diagram";
    private static String processedLevel3Path = "dataset/easyclinic/processed/code_description/description";

    private static String level1ToLevel2MatricPath = "dataset/easyclinic/trace_matrices/uc-id.txt";
    private static String level2ToLevel3MatricPath = "dataset/easyclinic/trace_matrices/id-cc.txt";
    private static String level1ToLevel3MatricPath = "dataset/easyclinic/trace_matrices/uc-cc.txt";


    private static String unprocessedLevel1Path = "dataset/easyclinic/unprocessed/use_case";
    private static String unprocessedLevel2Path = "dataset/easyclinic/unprocessed/interaction_diagram";
    private static String unprocessedLevel3Path = "dataset/easyclinic/unprocessed/code_description/description";

    private static String level1BitermPath = "/use_case";
    private static String level2BitermPath = "/interaction_diagram";
    private static String level3BitermPath = "/code_description";
    private static String bitermDirPath = "dataset/easyclinic/biterm/";

    @Override
    public String getCoreLevelBitermPath(ArtifactLevelEnum coreLevelEnum, ArtifactLevelEnum artifactLevelEnum) {
        String path = "";

        if(coreLevelEnum.equals(ArtifactLevelEnum.LEVEL1)) {
            path = bitermDirPath+"level1-core" +getBitermPath(artifactLevelEnum);
        } else if (coreLevelEnum.equals(ArtifactLevelEnum.LEVEL2)) {
            path = bitermDirPath+"level2-core" +getBitermPath(artifactLevelEnum);
        }else if (coreLevelEnum.equals(ArtifactLevelEnum.LEVEL3)) {
            path = bitermDirPath+"level3-core" +getBitermPath(artifactLevelEnum);
        }
        return path;
    }
