...
import experiment.enums.ArtifactTypeEnum;
...
public class EBT implements Project{
    ...
    private static ArtifactTypeEnum level1ArtifactTypeEnum = ArtifactTypeEnum.TEXT;
    private static ArtifactTypeEnum level2ArtifactTypeEnum = ArtifactTypeEnum.TEXT;
    private static ArtifactTypeEnum level3ArtifactTypeEnum = ArtifactTypeEnum.TEXT;
    ...
    private static String level1BitermPath = "/req";
    private static String level2BitermPath = "/test_case";
    private static String level3BitermPath = "/code";
    private static String bitermDirPath = "dataset/ebt/biterm/";
