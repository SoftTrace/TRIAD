...
public class ExtractDronoBiterm {
    ...
    public static void main(String[] args) {
        ...
        extractDronoBiterm.outputBiterms(level1BitermsMap, dronology.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL1));
        extractDronoBiterm.outputBiterms(level2BitermsMap, dronology.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL2));
        extractDronoBiterm.outputBiterms(level3BitermsMap, dronology.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL3));
    }

    private void initBitermDirectory() {
        FileIOUtil.initDirectory(dronology.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL1));
        FileIOUtil.initDirectory(dronology.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL2));
        FileIOUtil.initDirectory(dronology.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL3));
        FileIOUtil.initDirectory(dronology.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL4));
    }

    private void extractBiterms() {
        level2BitermsMap = getIssueTypeBitermMap(dronology.getUnprocessedLevel2ArtifactPath(), true);
        initCoreLevelBitermsSet = getInitCoreBitermSet(level2BitermsMap);

        initLevel3BitermsMap = getBitermFromClsMap();
        level3BitermsMap = getFinalClassBitermByeCoreMap(codeLayerBitermsNumMap, initCoreLevelBitermsSet);

        level1BitermsMap = getIssueTypeBitermMap(dronology.getUnprocessedLevel1ArtifactPath(), false);
    ...
    public ExtractDronoBiterm() {
        ...
        this.initCoreLevelBitermsSet = new HashSet<>();
    ...
    private static Map<String, Map<String, Integer>> getIssueTypeBitermMap(String issueDirPath, Boolean isCore) {
        Map<String, Map<String, Integer>> map = new HashMap<>();
    ...
    private static Set<String> getInitCoreBitermSet(Map<String, Map<String, Integer>> initCoreBitermsMap) {
        Set<String> set = new HashSet<>();
    ...
    private static Map<String, List<List<String>>> getBitermFromClsMap() {
