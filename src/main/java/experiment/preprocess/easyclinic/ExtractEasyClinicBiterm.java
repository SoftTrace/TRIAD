...
public class ExtractEasyClinicBiterm {
    ...
    private static Set<String> level1And3SharedBitermSet;
    ...
    public static void main(String[] args) {
        ...
        level1And3SharedBitermSet = extractEasyClinicBiterm.getSharedBiterms(initLevel1BitermsMap, initLevel2BitermsMap);
        level2And3SharedBitermSet = extractEasyClinicBiterm.getSharedBiterms(initLevel3BitermsMap, initLevel2BitermsMap);
        level1BitermsMap = extractEasyClinicBiterm.getFinalBiterm(initLevel1BitermsMap, level1And3SharedBitermSet);
        level3BitermsMap = extractEasyClinicBiterm.getFinalBiterm(initLevel3BitermsMap, level2And3SharedBitermSet);
        Set<String> set = new HashSet<>();
        set.addAll(level1And3SharedBitermSet);
        set.addAll(level2And3SharedBitermSet);
        level2BitermsMap = extractEasyClinicBiterm.getFinalBiterm(initLevel2BitermsMap, set);

        extractEasyClinicBiterm.outputBiterms(level1BitermsMap, easyClinic.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL1));
        extractEasyClinicBiterm.outputBiterms(level2BitermsMap, easyClinic.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL2));
        extractEasyClinicBiterm.outputBiterms(level3BitermsMap, easyClinic.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL3));
    }
    ...
    public ExtractEasyClinicBiterm() {
        ...
        this.level1And3SharedBitermSet = new HashSet<>();
        this.level2And3SharedBitermSet = new HashSet<>();
    }

    private void initBitermDirectory() {
        FileIOUtil.initDirectory(easyClinic.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL1));
        FileIOUtil.initDirectory(easyClinic.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL2));
        FileIOUtil.initDirectory(easyClinic.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL3));
    }
