...
public class ExtractWarcBiterm {
    ...
    public static void main(String[] args) {
        ...
        extractWarcBiterm.outputBiterms(level1BitermsMap, warc.getCoreLevelBitermPath(ArtifactLevelEnum.LEVEL2,ArtifactLevelEnum.LEVEL1));
        extractWarcBiterm.outputBiterms(level2BitermsMap, warc.getCoreLevelBitermPath(ArtifactLevelEnum.LEVEL2,ArtifactLevelEnum.LEVEL2));
        extractWarcBiterm.outputBiterms(level3BitermsMap, warc.getCoreLevelBitermPath(ArtifactLevelEnum.LEVEL2,ArtifactLevelEnum.LEVEL3));
    ...
    private void initBitermDirectory() {
        FileIOUtil.initDirectory(warc.getCoreLevelBitermPath(ArtifactLevelEnum.LEVEL2,ArtifactLevelEnum.LEVEL1));
        FileIOUtil.initDirectory(warc.getCoreLevelBitermPath(ArtifactLevelEnum.LEVEL2,ArtifactLevelEnum.LEVEL2));
        FileIOUtil.initDirectory(warc.getCoreLevelBitermPath(ArtifactLevelEnum.LEVEL2,ArtifactLevelEnum.LEVEL3));
    }
