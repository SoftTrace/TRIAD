...
public class RunCCodeProcess {

    public static ParseCodeXml parseCodeXml;
    ...
    public static void main(String[] args) {
        RunCCodeProcess runCCodeProcess = new RunCCodeProcess(new LibEST(), "test");
        parseCodeXml.run();
        initDir();
    ...
    public RunCCodeProcess(Project project, String  codeType) {
        this.parseCodeXml = new ParseCodeXml(project, codeType);
    ...
    private static void processCodeElement(Map<String, List<String>> codeElementMap, String codeElementDir) {
        for (String codeName : codeElementMap.keySet()) {
            ...
            System.out.println(unprocessedSb.toString());
