...
public class ExtractEbtBiterm {
    ...
    public static void main(String[] args) {
        ...
        extractEbtBiterm.outputBiterms(level1BitermsMap, ebt.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL1));
        extractEbtBiterm.outputBiterms(level2BitermsMap, ebt.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL2));
        extractEbtBiterm.outputBiterms(level3BitermsMap, ebt.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL3));
    }

    private void initBitermDirectory() {
        FileIOUtil.initDirectory(ebt.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL1));
        FileIOUtil.initDirectory(ebt.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL2));
        FileIOUtil.initDirectory(ebt.getCoreLevelBitermPath(coreLevel, ArtifactLevelEnum.LEVEL3));
    }
    ...
    private void extractBiterms() {
        level2BitermsMap = getTextTypeBitermMap(ebt.getUnprocessedLevel2ArtifactPath(), true);
        initCoreLevelBitermsSet = getInitCoreBitermSet(level2BitermsMap);

        level1BitermsMap = getTextTypeBitermMap(ebt.getUnprocessedLevel1ArtifactPath(), false);
    ...
    private static Map<String, Map<String, Integer>> getTextTypeBitermMap(String textCsvPath, Boolean isCore) {
        Map<String, Map<String, Integer>> map = new HashMap<>();
