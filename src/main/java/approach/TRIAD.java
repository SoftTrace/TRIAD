...
public class TRIAD {
    ...
    public Result compute(Project project, ArtifactLevelEnum sourceLevel, ArtifactLevelEnum targetLevel, ArtifactLevelEnum middleLevel, IRModel irModel, ALGO algorithm,
        ...
        Map<String, Map<String, Integer>> extendSourceBitermNumMap = BitermUtil.readBiterm(project.getCoreLevelBitermPath(middleLevel, sourceLevel));
        Map<String, Map<String, Integer>> sourceBitermNumMap = BitermUtil.readBiterm(project.getCoreLevelBitermPath(middleLevel, sourceLevel));
        Map<String, Map<String, Integer>> extendTargetBitermNumMap = BitermUtil.readBiterm(project.getCoreLevelBitermPath(middleLevel, targetLevel));
        Map<String, Map<String, Integer>> targetBitermNumMap = BitermUtil.readBiterm(project.getCoreLevelBitermPath(middleLevel, targetLevel));
        Map<String, Map<String, Integer>> middleBitermNumMap = BitermUtil.readBiterm(project.getCoreLevelBitermPath(middleLevel, middleLevel));
